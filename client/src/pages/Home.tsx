...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-50 via-emerald-100/90 to-emerald-200/80 dark:from-primary/10 dark:via-background dark:to-background">
      <ThemeToggle />
      <div 
