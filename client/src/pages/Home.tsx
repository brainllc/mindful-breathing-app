    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-blue-50/40 to-slate-50 dark:from-primary/10 dark:via-background dark:to-background will-change-transform">
      ...
      <main className="relative">
        <div className="container mx-auto px-4 pt-24 pb-16">
          ...
          >
            <h1 className="text-6xl font-bold tracking-tight mb-8 bg-gradient-to-b from-primary/90 to-primary/70 bg-clip-text text-transparent pb-4 will-change-transform leading-[1.2] font-display">
              Mindful Breathing
            </h1>
