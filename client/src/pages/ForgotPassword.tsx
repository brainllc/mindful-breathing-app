        ...
        <div className="container relative mx-auto px-4 pt-20">
          <div className="max-w-md mx-auto">
            <Card className="shadow-lg border-0 bg-white/80 dark:bg-card/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <Alert className="border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-900/20 flex-col items-center text-center">
                  <svg className="h-5 w-5 text-blue-600 dark:text-blue-400 mb-2" viewBox="0 0 24 24">
